...
#cp-toggle-btn {
  ...
  box-shadow:
    ...
    0 0 0 1px rgba(150, 181, 255, 0.18) inset,
    0 0 20px rgba(50, 76, 180, 0.15);
  display: flex;
  align-items: center;
...
#cp-toggle-btn:hover {
  background: rgba(28, 10, 40, 0.95);
  box-shadow:
    0 12px 40px rgba(0,0,0,0.7),
    0 0 0 1px rgba(150, 188, 255, 0.3) inset,
    0 0 30px rgba(60, 83, 200, 0.25);
...
#cp-toggle-btn.cp-is-playing::after {
  ...
  inset: -4px;
  border-radius: 50%;
  border: 1.5px solid rgba(130, 178, 255, 0.4);
...
#cp-root {
  ...
  box-shadow:
    ...
    0 0 0 1px rgba(150, 199, 255, 0.14) inset,
    0 0 40px rgba(20, 67, 120, 0.12);
  /* Hidden by default */
  opacity: 0;
...
.cp-border-ring {
  ...
  background: conic-gradient(
    ...
    transparent 0%,
    rgba(150, 218, 255, 0.55) 20%,
    rgba(80, 124, 200, 0.75) 40%,
    rgba(180, 209, 255, 0.45) 60%,
    transparent 80%
  );
...
.cp-light-orb {
  ...
  height: 120px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(140, 186, 255, 0.16) 0%, transparent 70%);
  pointer-events: none;
  z-index: 2;
  top: 0; left: 0;
...
.cp-cover-wrap {
  ...
  border-radius: 12px;
  overflow: hidden;
  box-shadow: 0 8px 32px rgba(0,0,0,0.55), 0 0 0 1px rgba(150, 204, 255, 0.1) inset;
  flex-shrink: 0;
  background: rgba(150, 209, 255, 0.06);
}
.cp-cover {
  width: 100%;
  height: 100%;
...
.cp-progress-track {
  position: relative;
  height: 3px;
  background: rgba(150, 194, 255, 0.12);
  border-radius: 2px;
  overflow: visible;
}
.cp-progress-fill {
  height: 100%;
  width: 0%;
  background: linear-gradient(90deg, rgba(60, 102, 200, 0.8), rgba(180, 241, 255, 0.95));
  border-radius: 2px;
...
.cp-progress-dot {
  ...
  box-shadow: 0 0 6px rgba(120, 161, 255, 0.8);
...
.cp-play-btn {
  ...
  background: rgba(150, 166, 255, 0.1);
...
.cp-play-btn:hover { background: rgba(150, 180, 255, 0.2); border-color: rgba(150, 185, 255, 0.4); }

@keyframes cp-play-pulse {
  0%   { box-shadow: 0 0 0 0 rgba(60, 114, 200, 0.4); }
...
.cp-vol-icon { width: 14px; height: 14px; flex-shrink: 0; color: rgba(150, 199, 255, 0.32); }
.cp-vol-track { position: relative; flex: 1; height: 3px; background: rgba(255,150,180,0.12); border-radius: 2px; }
.cp-vol-fill {
  position: absolute;
  inset: 0;
  width: 75%;
  background: linear-gradient(90deg, rgba(50, 111, 180, 0.65), rgba(150, 213, 255, 0.8));
  border-radius: 2px;
  pointer-events: none;
