...
window.FlowerEngine = (() => {
  ...
  function buildTextures() {
    ...
    const COLORS = {
      bg:     ['rgb(70, 130, 170)', 'rgb(50, 89, 130)',  'rgb(80, 148, 190)', 'rgb(60, 106, 150)'],
      mid:    ['rgb(95, 123, 215)', 'rgb(120, 166, 235)','rgb(140, 195, 250)','rgb(80, 128, 195)'],
      fg:     ['rgb(150, 195, 255)','rgb(120, 167, 255)','rgb(95, 137, 235)', 'rgb(170, 196, 255)'],
      cinema: ['rgb(130, 197, 255)','rgb(70, 122, 195)', 'rgb(95, 159, 255)'],
    };
    ...
    defs.forEach(d => {
      ...
      const color = palette ? palette[0] : 'rgb(195, 234, 255)';
      ...
      if (d.type === 'sakura') {
        ...
        c.fillStyle = 'rgba(185, 234, 255, 0.82)';
        c.fill();
        // subtle vein line
  ...
  ═══════════════════════════════════════════════════════════════ */
 const PAL = {
  bg:     ['rgba(70,110,170',  'rgba(50,90,130',   'rgba(80,125,190',  'rgba(60,100,150'],
  mid:    ['rgba(95,145,215',  'rgba(120,165,235', 'rgba(140,175,250', 'rgba(80,125,195'],
  fg:     ['rgba(150,185,255', 'rgba(120,165,255', 'rgba(95,140,235',  'rgba(170,205,255'],
  cinema: ['rgba(130,175,255', 'rgba(70,125,195',  'rgba(95,145,255'],
  dust:   ['rgba(195,215,255', 'rgba(110,195,247', 'rgba(175,200,255', 'rgba(215,235,255', 'rgba(145,170,200'],
};
  ...
  function render(now) {
    ...
    fog.addColorStop(0, 'rgba(6, 27, 75, 0)');
    fog.addColorStop(1, 'rgba(6, 17, 75, 0)');
    ctx.fillStyle = fog;
    ctx.globalAlpha = 1;
